export const PERMISSION_CATALOG = [
  ...
  { code: 'transactions.view', module: 'transactions', description: 'View payments and journals' },
  { code: 'transactions.create', module: 'transactions', description: 'Create payments and journals' },
