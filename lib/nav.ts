...
export const shopNavigation: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Users & roles', href: '/settings/users', icon: 'shield-checkmark-outline', permission: 'users.manage', audience: 'shop' },
      { label: 'Update password', href: '/settings/password', icon: 'lock-closed-outline', audience: 'both' },
      { label: 'Backup', href: '/settings/backup', icon: 'cloud-upload-outline', permission: 'settings.manage', audience: 'shop' },
      { label: 'Audit', href: '/settings/audit', icon: 'list-outline', permission: 'settings.manage', audience: 'shop' },
